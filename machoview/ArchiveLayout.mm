...
- (MVNode *)createSignatureNode:(MVNode *)parent
    ...
    [node.details appendRow:[NSString stringWithFormat:@"%.8lX", range.location] col1:lastReadHex col2:@"Signature" col3:signature];
    return node;
}
//----------------------------------------------------------------------------
...
- (MVNode *)createHeaderNode:(MVNode *)parent
    ...
    [node.details appendRow:[NSString stringWithFormat:@"%.8lX", range.location] col1:lastReadHex col2:@"UserID" col3:[NSString stringWithFormat:@"%u", [user_id_str intValue]]];

    NSString *group_id_str = [dataController read_string:range fixlen:6 lastReadHex:&lastReadHex];
    [node.details appendRow:[NSString stringWithFormat:@"%.8lX", range.location] col1:lastReadHex col2:@"GroupID" col3:[NSString stringWithFormat:@"%u", [group_id_str intValue]]];

    NSString *mode_str = [dataController read_string:range fixlen:8 lastReadHex:&lastReadHex];
    [node.details appendRow:[NSString stringWithFormat:@"%.8lX", range.location] col1:lastReadHex col2:@"Mode" col3:[NSString stringWithFormat:@"%u", [mode_str intValue]]];

    NSString *size_str = [dataController read_string:range fixlen:8 lastReadHex:&lastReadHex];
    [node.details appendRow:[NSString stringWithFormat:@"%.8lX", range.location] col1:lastReadHex col2:@"Size" col3:[NSString stringWithFormat:@"%u", [size_str intValue]]];
    ...
    [node.details appendRow:[NSString stringWithFormat:@"%.8lX", range.location - [padding length] + 2] col1:mutableLastReadHex col2:@"End Header" col3:padding];
    ...
    if (NSEqualRanges([name rangeOfString:@"#1/"], NSMakeRange(0, 3))) {
        ...
        [node.details appendRow:[NSString stringWithFormat:@"%.8lX", range.location] col1:lastReadHex col2:@"Long Name" col3:long_name];
...
- (MVNode *)createMemberNode:(MVNode *)parent
    ...
    [node.details appendRow:[NSString stringWithFormat:@"%.8lX", range.location] col1:lastReadHex col2:@"Size" col3:[NSString stringWithFormat:@"%u", size]];
    ...
    while (size > 0) {
        ...
        [node.details appendRow:[NSString stringWithFormat:@"%.8lX", range.location] col1:lastReadHex col2:@"Object" col3:objectInfo.name];

...
- (MVNode *)createObjCClassNode:(MVNode *)parent
    ...
    if (objc_class_t->info & 0x8) [node.details appendRow:@"" col1:@"" col2:@"    8" col3:@"CLS_POSING"];
    if (objc_class_t->info & 0x10) [node.details appendRow:@"" col1:@"" col2:@"   10" col3:@"CLS_MAPPED"];
    if (objc_class_t->info & 0x20) [node.details appendRow:@"" col1:@"" col2:@"   20" col3:@"CLS_FLUSH_CACHE"];
    if (objc_class_t->info & 0x40) [node.details appendRow:@"" col1:@"" col2:@"   40" col3:@"CLS_GROW_CACHE"];
    if (objc_class_t->info & 0x80) [node.details appendRow:@"" col1:@"" col2:@"   80" col3:@"CLS_NEED_BIND"];
    if (objc_class_t->info & 0x100) [node.details appendRow:@"" col1:@"" col2:@"  100" col3:@"CLS_METHOD_ARRAY"];
    if (objc_class_t->info & 0x200) [node.details appendRow:@"" col1:@"" col2:@"  200" col3:@"CLS_JAVA_HYBRID"];
    if (objc_class_t->info & 0x400) [node.details appendRow:@"" col1:@"" col2:@"  400" col3:@"CLS_JAVA_CLASS"];
    if (objc_class_t->info & 0x800) [node.details appendRow:@"" col1:@"" col2:@"  800" col3:@"CLS_INITIALIZING"];
    if (objc_class_t->info & 0x1000) [node.details appendRow:@"" col1:@"" col2:@" 1000" col3:@"CLS_FROM_BUNDLE"];
    if (objc_class_t->info & 0x2000) [node.details appendRow:@"" col1:@"" col2:@" 2000" col3:@"CLS_HAS_CXX_STRUCTORS"];
    if (objc_class_t->info & 0x4000) [node.details appendRow:@"" col1:@"" col2:@" 4000" col3:@"CLS_NO_METHOD_ARRAY"];
